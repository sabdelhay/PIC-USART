# 1 "../../LCD_Driver/lcd_driver.X/dio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../LCD_Driver/lcd_driver.X/dio.c" 2
...
# 1 "../../LCD_Driver/lcd_driver.X/dio.h" 1
# 15 "../../LCD_Driver/lcd_driver.X/dio.h"
...
# 7 "../../LCD_Driver/lcd_driver.X/dio.c" 2

# 1 "../../LCD_Driver/lcd_driver.X/std_macros.h" 1
# 8 "../../LCD_Driver/lcd_driver.X/dio.c" 2
...
# 9 "../../LCD_Driver/lcd_driver.X/dio.c" 2
...
char DIO_read(char port, char pin){
 ...
 switch(port){
  case 'A':
  case 'a':
   returned_val = ((PORTA&(1<<pin))>>pin);
  break;

  case 'B':
  case 'b':
  returned_val = ((PORTB&(1<<pin))>>pin);
  break;

  case 'C':
  case 'c':
  returned_val = ((PORTC&(1<<pin))>>pin);
  break;

  case 'D':
  case 'd':
  returned_val = ((PORTD&(1<<pin))>>pin);
  break;
  default: break;
 }
 return returned_val;
